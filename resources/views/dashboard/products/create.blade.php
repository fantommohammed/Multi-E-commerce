                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="number-tab-steps wizard-circle"
                                              action="{{route('admin.products.general.store')}}" method="POST"
                                        ...
                                        <!-- Step 1 -->
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1">{{__('admin/setting.begindatediscount')}}</label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1">{{__('admin/setting.enddatediscount')}}</label>
                                            ...
                                            <fieldset>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1">{{__('admin/setting.trackstock')}}</label>
                                                            <select name="manage_stock" style="width: 100%"
                                                                    class="select2 form-control" id="manageStock">
                                                                <optgroup label="{{__('admin/setting.plzchoosetype')}}">
                                                                    <option value="1">{{__('admin/setting.enabletrack')}}</option>
                                                                    <option value="0" selected>{{__('admin/setting.disabletrack')}}</option>
                                                                </optgroup>
                                                            </select>
                                                            @error('manage_stock')
                                                            <span class="text-danger"> {{$message}}</span>
