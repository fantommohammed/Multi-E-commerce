        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title">{{__('admin/setting.products')}}</h3>
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a
                                        href="{{route('admin.dashboard')}}">{{__('admin/setting.home')}}</a></li>
                                <li class="breadcrumb-item active">{{__('admin/setting.products')}}</li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">{{__('admin/setting.allproducts')}}</h4>
                                                            ...
                                                            <td>
                                                                <div class="btn-group" role="group"
                                                                    ...
                                                                    <a href="{{route('admin.products.delete',$product -> id)}}"
                                                                       class="btn btn-outline-primary btn-min-width box-shadow-3 mr-1 mb-1">{{__('admin/setting.delete')}}</a>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    @endforeach
