                        ...
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('admin.subcategories')}}">الاقسام
                                        الفرعية{{__('admin/setting.home')}}</a>
                                </li>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title"
                                        id="basic-layout-form"> {{__('admin/setting.editsubcategories')}}</h4>
                                    ...
                                    <div class="card-body">
                                        <form class="form"
                                            ...
                                            <div class="form-group">
                                                <div class="text-center">
                                                    <img
                                                        ...
                                                        alt="{{__('admin/setting.subcategorypicture')}}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label
                                                                for="projectinput2"> {{__('admin/setting.maincategoriesselect')}}</label>
                                                                    ...
                                                                    @if($categories && $categories->count()>0)
                                                                        @foreach($categories as $maincategory)
                                                                            <option value="{{$maincategory->id}}"
                                                                                    @if($maincategory-> id == $category->parent_id) selected @endif>{{$maincategory->name}}</option>
                                                                        @endforeach
                                                                    @endif
                                                                </optgroup>
                                                            </select>
                                            ...
                                            <div class="form-body">
                                                ...
                                                <h4 class="form-section"><i
                                                        class="ft-home"></i> {{__('admin/setting.subcategorydata')}}
                                                </h4>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label
                                                                for="projectinput1"> {{__('admin/setting.subcategoryname')}}</label>
