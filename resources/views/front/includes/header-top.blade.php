            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 d-flex justify-content-end align-items-center header-top-right">
                    ...
                    <div id="_desktop_language_selector"
                        ...
                        <div class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                             role="main">
                            <span class="expand-more"><img class="img-fluid" src="{{asset('assets/front/img/1.jpg')}}" alt="English" width="16"
                                                           height="11"></span>
                        </div>
                                ...
                                <div class="language-item">
                                    <div>
                                        <a href="http://demo.bestprestashoptheme.com/savemart/fr/?home=home_3">
                                            <img class="img-fluid" src="{{asset('assets/front/img/2.jpg')}}" alt="Français" width="16"
                                                 height="11">
                                            <span>Français</span>
                                        </a>
                                    </div>
                                ...
                                <div class="language-item">
                                    <div>
                                        <a href="http://demo.bestprestashoptheme.com/savemart/es/?home=home_3">
                                            <img class="img-fluid" src="{{asset('assets/front/img/2.jpg')}}" alt="Español" width="16" height="11">
                                            <span>Español</span>
                                        </a>
                                    </div>
                                </div>
                                <div class="language-item">
                                    <div>
                                        <a href="http://demo.bestprestashoptheme.com/savemart/it/?home=home_3">
                                            <img class="img-fluid" src="{{asset('assets/front/img/1.jpg')}}" alt="Italiano" width="16"
                                                 height="11">
                                            <span>Italiano</span>
                                        </a>
                                    </div>
                                ...
                                <div class="language-item">
                                    <div>
                                        <a href="http://demo.bestprestashoptheme.com/savemart/pl/?home=home_3">
                                            <img class="img-fluid" src="{{asset('assets/front/img/5.jpg')}}" alt="Polski" width="16" height="11">
                                            <span>Polski</span>
                                        </a>
                                    </div>
                                </div>
                                <div class="language-item">
                                    <div>
                                        <a href="http://demo.bestprestashoptheme.com/savemart/ar/?home=home_3">
                                            <img class="img-fluid" src="{{asset('assets/front/img/6.jpg')}}" alt="اللغة العربية" width="16"
                                                 height="11">
